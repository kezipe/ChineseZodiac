...
final class MatchResultCell: UITableViewCell {
    ...
    func setupUI() {
        ...
        person1Zodiac.leftAnchor.constraint(equalTo: leftAnchor, constant: PADDING_HORIZONTAL)
            .isActive = true
        ...
        person1Name.leftAnchor.constraint(equalTo: leftAnchor, constant: PADDING_HORIZONTAL)
            .isActive = true
        person1Name.topAnchor.constraint(
            equalTo: topAnchor,
        ...
        person2Zodiac.rightAnchor.constraint(equalTo: rightAnchor, constant: -PADDING_HORIZONTAL)
            .isActive = true
        ...
        person2Name.rightAnchor.constraint(equalTo: rightAnchor, constant: -PADDING_HORIZONTAL)
            .isActive = true
        person2Name.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -PADDING_VERTICAL)
            .isActive = true
